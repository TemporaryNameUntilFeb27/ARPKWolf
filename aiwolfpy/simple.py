...
class SampleAgent(object):
        ...
        if request == 'DAILY_INITIALIZE':
            ...
            for i in range(self.diff_data.shape[0]):
                ...
                if content[0] == 'DIVINED':
                    ...
                    print("Agent"+str(self.diff_data.agent[i])+"の占い結果"+str(self.divined_result_dic[self.diff_data.agent[i]]))
    ...
    def vote(self):
        ...
        #役職持ち以外、白だしされていない人からグレラン
            ...
            print("役職持ちグレーからランダムに投票します")
            print(set(self.alive_list)-set(self.with_potision_list))
            ...
            print("占われていない人がいないので次の人の中から占います")
